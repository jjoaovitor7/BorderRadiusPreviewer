function codeBox(input1, input2, input3, input4) {
  ...
  // se o checkbox do moz estiver checkado
    ...
    code.innerHTML = `-moz-border-radius: ${input1}px ${input2}px ${input3}px ${input4}px;`;
  }

  // se o checkbox do webkit estiver checkado
  else if (WEBKITChecked && !MOZChecked && !CSS3Checked) {
    code.innerHTML = `-webkit-border-radius: ${input1}px ${input2}px ${input3}px ${input4}px;`;
  }

  // se o checkbox do css3 e do moz estiverem checkados
  else if (CSS3Checked && MOZChecked && !WEBKITChecked) {
    code.innerHTML = `border-radius: ${input1}px ${input2}px ${input3}px ${input4}px;`;
    code.innerHTML += `<br/>-moz-border-radius: ${input1}px ${input2}px ${input3}px ${input4}px;`;
  }

  // se o checkbox do css3 e do webkit estiverem checkados
  else if (CSS3Checked && !MOZChecked && WEBKITChecked) {
    code.innerHTML = `border-radius: ${input1}px ${input2}px ${input3}px ${input4}px;`;
    code.innerHTML += `<br/>-webkit-border-radius: ${input1}px ${input2}px ${input3}px ${input4}px;`;
  }
